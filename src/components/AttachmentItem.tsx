...
export default function AttachmentItem({ 
  ...
  return (
    <div className={`flex items-center p-2 rounded-lg border border-gray-200 dark:border-gray-700 ${className}`}>
      {type.startsWith('image/') && thumbnailUrl ? (
        <div className="relative mr-2 w-8 h-8 overflow-hidden rounded flex-shrink-0">
          <img 
            src={thumbnailUrl} 
            alt={name}
            className="w-full h-full object-cover" 
        ...
        <div className="flex items-center justify-center mr-2 w-8 h-8 rounded bg-blue-100 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 flex-shrink-0">
      ...
      {onRemove && (
        <button
          ...
          className="ml-2 p-0.5 text-gray-400 hover:text-red-600 dark:hover:text-red-500 focus:outline-none"
