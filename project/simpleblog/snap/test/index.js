...
exports.onLoad = async() => { 
	console.log("onLoad:", this.running); // should be true 
	// do something
}

exports.onExit = async() => { 
	console.log("onExit:", this.running); // should be false
	// do something
}

exports.onError = async(_ev, _err) => { 
	// do something
	console.error(_ev, _err);
}
...
exports.handler = async(req, res) => {
	...
	//STORE.test.fn();
	//res.end('Hello Snap v' + this.setup.version + '! My test key: ' + OPTION["test-key"] + " - " + STORE.test.variable);
...
exports.event = {
	...
	"instance.load.route": handleEvent,
	*/
}
